    ...
    <div className="relative h-60 bg-background border rounded-lg mb-4">
      <div className="absolute inset-y-0 left-2 right-2">
        ...
        <div className="h-60 overflow-y-auto overflow-x-hidden p-2 relative">
          {clips.map((clip) => {
            const { id, name, startTime, duration, track } = clip;
            ...
            return (
              <div
                ...
                className={`absolute h-12 rounded flex items-center justify-center text-sm cursor-pointer transition-all select-none
                ${
                  isSelected
